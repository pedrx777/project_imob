        ...
        <div class="row">
            ...
            <article class="col-12 col-md-6 col-lg-4 mb-4">
                <div class="card main_properties_item">
                    <div class="img-responsive-16by9">
                        <a href="">
                            <img src="pack-de-imagens/properties/1/5a3571ab-4d76-466f-8246-eff8cb98cedd.jpg" class="card-img-top" alt="">
                        </a>
                    </div>
                    <div class="card-body">
                        <h2><a href="" class="text-front">Linda Casa no Rio de Janeiro com vista para o Mar</a></h2>
                        <p class="main_properties_item_category">Imóvel Residencial</p>
                        <p class="main_properties_item_type">Apartamento - Rio de Janeiro <i class="icon-location-arrow"></i></p>
            ...
            <article class="col-12 col-md-6 col-lg-4 mb-4">
                <div class="card main_properties_item">
                    <div class="img-responsive-16by9">
                        <a href="">
                            <img src="pack-de-imagens/properties/2/a56fc386-3790-4e98-a72c-3b09d24adecd.jpg" class="card-img-top" alt="">
                        </a>
                    </div>
                    <div class="card-body">
                        <h2><a href="" class="text-front">Linda Casa no Rio de Janeiro com vista para o Mar</a></h2>
            ...
            <article class="col-12 col-md-6 col-lg-4 mb-4">
                <div class="card main_properties_item">
                    <div class="img-responsive-16by9">
                        <a href="">
                            <img src="pack-de-imagens/properties/3/667d07e1-c0ac-4e3b-b450-4bc9bcc9bffb.jpg" class="card-img-top" alt="">
                        </a>
                    </div>
                    <div class="card-body">
                        <h2><a href="" class="text-front">Linda Casa no Rio de Janeiro com vista para o Mar</a></h2>
        ...
        <div class="row">
            ...
            <article class="col-12 col-md-6 col-lg-4 mb-4">
                <div class="card main_properties_item">
                    <div class="img-responsive-16by9">
                        <a href="">
                            <img src="pack-de-imagens/properties/4/3d656134-3760-4c9a-af1a-503301acc0be.jpg" class="card-img-top" alt="">
                        </a>
                    </div>
                    <div class="card-body">
                        <h2><a href="" class="text-front">Linda Casa no Rio de Janeiro com vista para o Mar</a></h2>
            ...
            <article class="col-12 col-md-6 col-lg-4 mb-4">
                <div class="card main_properties_item">
                    <div class="img-responsive-16by9">
                        <a href="">
                            <img src="pack-de-imagens/properties/5/8771b309-8314-4023-89a8-1f1b01165075.jpg" class="card-img-top" alt="">
                        </a>
                    </div>
                    <div class="card-body">
                        <h2><a href="" class="text-front">Linda Casa no Rio de Janeiro com vista para o Mar</a></h2>
            ...
            <article class="col-12 col-md-6 col-lg-4 mb-4">
                <div class="card main_properties_item">
                    <div class="img-responsive-16by9">
                        <a href="">
                            <img src="pack-de-imagens/properties/2/4941f006-f53b-4548-9a9f-fa5712bbfb1f.jpg" class="card-img-top" alt="">
                        </a>
                    </div>
                    <div class="card-body">
                        <h2><a href="" class="text-front">Linda Casa no Rio de Janeiro com vista para o Mar</a></h2>
